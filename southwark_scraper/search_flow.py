"""High-level flow for searching postcode results."""
...
from .parse_southwark import parse_search_results
...
def _load_search_page(env: BrowserEnv, page, postcode: str, settings: Settings) -> None:
    def _attempt() -> None:
...
def _fill_search_form(env: BrowserEnv, page, postcode: str, settings: Settings) -> None:
    try:
